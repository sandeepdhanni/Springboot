...
public class EvenAndOddPrint {
    ...
    public static void main(String[] args) throws InterruptedException {
        CompletableFuture.runAsync(() -> EvenAndOddPrint.printResults(oddCondition));
        CompletableFuture.runAsync(() -> EvenAndOddPrint.printResults(evenCondition));
        Thread.sleep(1000);
    }
    ...
    public static void printResults(IntPredicate condition) {
        IntStream.rangeClosed(1, 10)
                .filter(condition)
                .forEach(EvenAndOddPrint::execute);
    }
